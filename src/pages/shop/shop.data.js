  ...
  nigiri: {
    ...
    items: [
      ...
      },
      {
        ...
        name: 'Toro nigiri',
        description:
          'Delicious nigiri made with the belly-part of the bluefin tuna',
        imageUrl: '/',
        pieces: 1,
        price: 8.5,
      },
    ...
    items: [
      {
        ...
        description:
          "This is our recommended special roll. It's just amazing. Try it!",
        pieces: 8,
        price: 25,
        imageUrl: '.',
      },
    ...
    items: [
      {
        id: 7,
        name: 'Salmon Mix',
        description: 'For the real salmon lovers only',
        pieces: 18,
        price: 25,
        imageUrl: '.',
      },
      ...
      },
      {
        id: 10,
        name: 'Vegan Only Mix',
        description: 'For the real vegans among us',
        pieces: 18,
        price: 25,
        imageUrl: '.',
      },
    ...
    items: [
      {
        ...
        description: 'For the real salmon sashimi lovers',
        pieces: 12,
        price: 28,
        imageUrl: '.',
      },
      {
        ...
        description:
          'Impress your friends or family with this amazing sashimi boat',
        pieces: 64,
        price: 109,
        imageUrl: '.',
      },
